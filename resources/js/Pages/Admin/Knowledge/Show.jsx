...
function AnswerForm({ question }) {
    ...
    return (
        <>
            ...
            <Modal show={isConfirmOpen} maxWidth="sm" onClose={() => setIsConfirmOpen(false)}>
                <div className="p-6">
                    <h3 className="text-lg font-bold text-gray-900">답변 저장 확인</h3>
        ...
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">보험 Q&A 상세</h2>}>
            ...
            <div className="py-8">
                <div className="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
                    <Link href={route('admin.knowledge.index')} className="inline-flex text-sm font-semibold text-gray-600 hover:text-gray-900">
                        목록으로
                    </Link>
                    {flash?.success && (
                    ...
                    <section className="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200">
                        <div className="flex flex-wrap items-center gap-2">
                            <span className="rounded-lg bg-gray-100 px-2 py-1 text-xs font-semibold text-gray-700">{question.statusLabel}</span>
                        ...
                        <div className="mt-6">
                            <h2 className="text-base font-bold text-gray-900">질문 내용</h2>
                            <p className="mt-2 whitespace-pre-line rounded-md border border-gray-200 p-4 text-sm leading-6 text-gray-700">
                                {question.body}
                            </p>
                        </div>
                    </section>
                    <section className="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200">
                        <h2 className="mb-4 text-base font-bold text-gray-900">답변 관리</h2>
